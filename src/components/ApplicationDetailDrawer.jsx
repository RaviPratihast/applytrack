...
function ApplicationDetailDrawer({ application, onClose }) {
  ...
  const appliedDate = formatLongDate(application?.appliedDate);
  const followUpDate = application?.followUpDate ? formatLongDate(application.followUpDate) : null;
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
              ...
              <div>
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Button
                    size="sm"
                    className="rounded-[10px] bg-app-accent text-black hover:bg-app-accent/80 transition-opacity disabled:opacity-50 disabled:bg-muted disabled:text-muted-foreground"
